...
public class StreamDemo {
	...
	public static void main(String[] args) {
		...
		empList.add(new Employee(101, "Vijendhar", 10000));
		empList.add(new Employee(102, "jai", 18000));
		empList.add(new Employee(103, "Laxmi", 12000));
		empList.add(new Employee(104, "Basu", 15000));
		empList.add(new Employee(105, "Ritish", 20000));
